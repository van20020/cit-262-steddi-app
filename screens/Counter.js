...
if (currentScreen === 'counter'){
  ...
  return (
     ...
     <Card style={{backgroundColor:'grey', borderRadius: 10, marginTop: 10, marginBottom:10 ,width: 340, shadowColor: "#000",
shadowOffset: {
	width: 0,
	height: 2,
},
...
<CardContent>
  ...
  <TouchableOpacity
     onPress={ subscription ? _unsubscribe : _subscribe}
      style={styles.button}
    >
      <Text style={{color:'white', fontSize:20}}>{subscription ? 'Add step' : 'Start'}</Text>
     </TouchableOpacity>
